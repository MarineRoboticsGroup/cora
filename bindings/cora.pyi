...
class Problem:
    ...
    def getTranslationExplicitSolution(self, Y: NDArray[np.float64]) -> NDArray[np.float64]: ...
...
def extractRelaxedPose(problem: Problem, Y: NDArray[np.float64], pose_sym: Symbol) -> Tuple[NDArray[np.float64], NDArray[np.float64]]: ...


def extractRelaxedPoint(problem: Problem, Y: NDArray[np.float64], point_sym: Symbol) -> NDArray[np.float64]: ...
