...
class InitializationMap:
    ...
    def clear(self) -> None: ...
    def set_pose_initialization(self, symbol: Symbol, R: NDArray[np.float64], t: NDArray[np.float64]) -> None: ...
    def has_pose_initialization(self, symbol: Symbol) -> bool: ...
    ...
    def set_landmark_initialization(self, symbol: Symbol, p: NDArray[np.float64]) -> None: ...
    def has_landmark_initialization(self, symbol: Symbol) -> bool: ...
    def get_landmark(self, symbol: Symbol) -> NDArray[np.float64] | None: ...


def getInitialMatrixFromInitMap(problem: Problem, inits: InitializationMap, relaxation_rank: int) -> NDArray[np.float64]: ...
